...
class Base(Configuration):
    ...
    MIDDLEWARE = [
        ...
        "{{cookiecutter.project_slug}}.middleware.TimezoneMiddleware",
    ...
    DATABASES = values.DatabaseURLValue("postgresql://{{cookiecutter.project_slug}}_user:{{cookiecutter.project_slug}}_pass@127.0.0.1:5432/{{cookiecutter.project_slug}}_db")
